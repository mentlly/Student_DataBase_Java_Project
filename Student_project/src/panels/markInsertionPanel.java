...
public class markInsertionPanel extends JPanel {
    public markInsertionPanel (database db) {
        ...
        submitButton.addActionListener(x -> {
            try {
                ...
                int status = db.studentMarkInsertion(regNoField.getText(), m1, m2, m3);
                if (status == 0) {
                    regNoField.setText("");
                    mark1Field.setValue(null);
                    mark2Field.setValue(null);
                    mark3Field.setValue(null);
                    resultText.setText("The student marks was entered");
                } else if (status == 1) {
                    resultText.setText ("This student marks was already entered");
                } else if (status == 3) {
